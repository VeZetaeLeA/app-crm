<div class="row g-4 mb-5">
    <div class="col-12 d-flex align-items-center justify-content-between mb-2">
        ...
        <div class="d-flex gap-2">
            <a href="<?php echo url('project/exportCsv'); ?>"
                class="btn btn-outline-white btn-sm px-4 rounded-pill fw-bold border-white-10 d-flex align-items-center gap-2 no-print">
            ...
            <div class="col-md-6 col-xxl-4">
                <div class="glass-morphism h-100 rounded-5 border-white-10 overflow-hidden hover-lift transition-all">
                    ...
                    <div class="p-4">
                        ...
                        <a href="<?php echo url('project/timeline/' . $service['id']); ?>"
                            class="btn btn-outline-light w-100 rounded-pill fw-bold border-white-10 text-white-50 hover-gold transition-all">
                            <span class="material-symbols-outlined fs-6 align-middle me-1">timeline</span> Ver Timeline
                        </a>
                    </div>
                </div>
            </div>
