                    ...
                    <div class="col-md-6 col-xxl-4">
                        <div
                            ...
                            <div class="mb-3">
                                <?php
                                $statusConfig = [
                                    'pending_review' => ['label' => 'Pendiente', 'icon' => 'pending', 'class' => 'bg-warning-subtle text-warning border-warning'],
                                ...
                                ?>
                                <span class="badge border <?php echo $st['class']; ?> x-small fw-bold d-flex align-items-center gap-1 px-2 py-1 w-fit">
                            ...
                            <?php if (!empty($file['review_notes'])): ?>
                                <div class="rounded-3 p-2 mb-3 bg-white-5 border border-white-10">
                                    <p class="x-small text-white-50 mb-1 fw-bold uppercase" style="font-size:0.6rem">Notas del Cliente:</p>
                                    <p class="x-small text-white mb-0 italic">"<?php echo htmlspecialchars($file['review_notes']); ?>"</p>
                                </div>
                            <?php endif; ?>
